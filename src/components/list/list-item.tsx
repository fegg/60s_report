...
import { NativeProps, withNativeProps } from '../slider/utils/native-props';
...
export const ListItem: FC<ListItemProps> = (props) => {
  ...
  const content = (
    <div className={`${classPrefix}-content ${classPrefix}-content-abc`}>
      ...
      {arrow && (
        <>
          <div className={`${classPrefix}-content-arrow`}>
            {/* <div className={`${classPrefix}-content-arrow-open`}>收起</div>
            <div className={`${classPrefix}-content-arrow-close`}>打开</div> */}
